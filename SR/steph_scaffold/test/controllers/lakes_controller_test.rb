...
class LakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lake" do
    assert_difference('Lake.count') do
      post lakes_url, params: { lake: { circumference: @lake.circumference, deptht: @lake.deptht, location: @lake.location, name: @lake.name } }
    end
  ...
  test "should update lake" do
    patch lake_url(@lake), params: { lake: { circumference: @lake.circumference, deptht: @lake.deptht, location: @lake.location, name: @lake.name } }
